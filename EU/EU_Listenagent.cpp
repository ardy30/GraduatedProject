...
#include "EU_Agent.h"
EU_Listenagent::EU_Listenagent()
{
    m_port = 32602;
    fd = -1;
}
int EU_Listenagent::setnonblocking (int fd) const
{
    int flag;
...
int EU_Listenagent::initialserver()
{
...
int EU_Listenagent::readagent()
{
    ...
    Agent* agent = new EU_Agent(connfd);    
